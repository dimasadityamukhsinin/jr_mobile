...
class PageTwoPetugas extends StatefulWidget {
  final VoidCallback keluar;
  PageTwoPetugas(this.keluar);

  @override
  _PageTwoPetugasState createState() => _PageTwoPetugasState();
}

enum SingingCharacter { lafayette, jefferson }

class _PageTwoPetugasState extends State<PageTwoPetugas> {
...
// Method to convert the connectivity to a string value
  ...
  Future<Null> getUserDetails() async {
    ...
    nama = preferences.getString("nama");
    ttd = preferences.getString("ttd");
    regional = preferences.getString("regional");
...
final String url = 'http://dtd.jasaraharjariau.com/api/data/$regional';
...
class _EditDataState extends State<EditData> {
  ...
  void checkConnectivity1(var id, var ttd, var datakondisi) async {
    var connectivityResult = await connectivity.checkConnectivity();
    var conn = getConnectionValue(connectivityResult);
    setState(() {
...
// Method to convert the connectivity to a string value
  ...
  updatedata(var id, var ttd, var datakondisi) async {
    if (janjibayar.toString() != null && datakondisi == "Beroperasi" ||
      ...
      if (ttd == null && gambar.toString() == "[]") {
        if (_imageFile != null &&
          ...
          responsegambar =
              await _uploadImage(_imageFile, id, status, datakondisi);
  ...
  Future<Map<String, dynamic>> _uploadImage(
      File image, var id, var status, var datakondisi) async {
    setState(() {
      _isUploading = true;
    });

    String baseUrl = 'http://dtd.jasaraharjariau.com/androids/editdatauser.php';
              ...
              children: <Widget>[
                ...
                DateTimeField(
                  ...
                  validator: (e) {
                    if (e == null) {
                      loading = false;
                      return "Silahkan masukkan tanggal pelaksanaan anda";
                    }
                  },
                  format: format,
                  onShowPicker: (context, currentValue) {
