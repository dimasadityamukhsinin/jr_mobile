...
import 'package:jasaraharja/ViewPetugas/Profil.dart';
import 'package:jasaraharja/ViewPetugas/homepage.dart';
import 'package:rich_alert/rich_alert.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:jasaraharja/clipper.dart';
import 'package:http/http.dart' as http;

class PageOnePetugas extends StatefulWidget {
  final VoidCallback keluar;
  PageOnePetugas(this.keluar);

  @override
  _PageOnePetugasState createState() => _PageOnePetugasState();
}

class _PageOnePetugasState extends State<PageOnePetugas>
    with AutomaticKeepAliveClientMixin<PageOnePetugas> {
  bool get wantKeepAlive => true;
  var data = [0.0, 5.0, 2.0, 4.0, 3.0, 8.0, 10.0];
  int _current = 0;

  String nama, ttd, id, namaregional, regional;
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return RichAlertDialog(
                ...
                alertSubtitle: richSubtitle("Tanda tangan tidak ditemukan,\n mohon segera dilengkapi!"),
...
// Method to convert the connectivity to a string value
  ...
  Future getPref() => _memoizer.runOnce(() async {
        ...
        namaregional = preferences.getString("nama_regional");
        final response =
            await http.get("http://dtd.jasaraharjariau.com/api/grafik/$regional");
