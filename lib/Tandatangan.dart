  ...
  Future<Null> showImage(BuildContext context) async {
    ...
    return showDialog<Null>(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text(
              'Silahkan lihat hasilnya di folder Tanda Tangan',
              style: TextStyle(
                fontFamily: 'Roboto',
