...
class PageTwoAdmin extends StatefulWidget {
  final VoidCallback keluar;
  PageTwoAdmin(this.keluar);

  @override
  _PageTwoAdminState createState() => _PageTwoAdminState();
}

enum SingingCharacter { lafayette, jefferson }

class _PageTwoAdminState extends State<PageTwoAdmin> {
