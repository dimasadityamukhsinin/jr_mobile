...
import 'package:jasaraharja/ViewAdmin/Profil.dart';
import 'package:jasaraharja/ViewAdmin/homepage.dart';
import 'package:rich_alert/rich_alert.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:jasaraharja/clipper.dart';
import 'package:http/http.dart' as http;

class PageOneAdmin extends StatefulWidget {
  final VoidCallback keluar;
  PageOneAdmin(this.keluar);

  @override
  _PageOneAdminState createState() => _PageOneAdminState();
}

class _PageOneAdminState extends State<PageOneAdmin>
    with AutomaticKeepAliveClientMixin<PageOneAdmin> {
