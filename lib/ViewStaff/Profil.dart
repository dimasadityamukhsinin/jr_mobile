...
class ProfilStaff extends StatefulWidget {
  final VoidCallback keluar;
  ProfilStaff(this.keluar);

  @override
  _ProfilStaffState createState() => _ProfilStaffState();
}

class _ProfilStaffState extends State<ProfilStaff> {
  String nama,
      id,
      kodesamsat,
      cabang,
