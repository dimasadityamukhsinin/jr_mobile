...
import 'package:jasaraharja/ViewKasubag/Profil.dart';
...
class PageOneKasubag extends StatefulWidget {
  final VoidCallback keluar;
  PageOneKasubag(this.keluar);

  @override
  _PageOneKasubagState createState() => _PageOneKasubagState();
}

class _PageOneKasubagState extends State<PageOneKasubag>
    with AutomaticKeepAliveClientMixin<PageOneKasubag> {
