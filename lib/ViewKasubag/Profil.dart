...
class ProfilKasubag extends StatefulWidget {
  final VoidCallback keluar;
  ProfilKasubag(this.keluar);

  @override
  _ProfilKasubagState createState() => _ProfilKasubagState();
}

class _ProfilKasubagState extends State<ProfilKasubag> {
  String nama,
      id,
      kodesamsat,
      cabang,
