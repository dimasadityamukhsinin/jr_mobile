...
class PageTwoKasubag extends StatefulWidget {
  final VoidCallback keluar;
  PageTwoKasubag(this.keluar);

  @override
  _PageTwoKasubagState createState() => _PageTwoKasubagState();
}

enum SingingCharacter { lafayette, jefferson }

class _PageTwoKasubagState extends State<PageTwoKasubag> {
...
// Method to convert the connectivity to a string value
  ...
  hapusdata(var id) async {
    final response =
        await http.delete('http://dtd.jasaraharjariau.com/api/data/$id');
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return RichAlertDialog(
              ...
              alertSubtitle: richSubtitle("Data berhasil di dihapus!"),
      ...
      child: new Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            showDialog(
                context: context,
                builder: (_) => TambahData(keluar, _currentAddress));
          },
...
class TambahData extends StatefulWidget {
  final VoidCallback keluar;
  var dataalamat;
  TambahData(this.keluar, this.dataalamat);

  @override
  _TambahDataState createState() => _TambahDataState(this.dataalamat);
}
...
class _TambahDataState extends State<TambahData> {
  ...
  var masaawal, masaakhir, dataalamat;
  _TambahDataState(this.dataalamat);
  final format = DateFormat("yyyy-MM-dd");
  String pekanbaru = "pekanbaru";
  String dumai = "dumai";
  String siak = "siak";
