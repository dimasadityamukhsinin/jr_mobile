...
import 'package:jasaraharja/ViewKepalacabang/Profil.dart';
...
class PageOneKepalacabang extends StatefulWidget {
  final VoidCallback keluar;
  PageOneKepalacabang(this.keluar);

  @override
  _PageOneKepalacabangState createState() => _PageOneKepalacabangState();
}

class _PageOneKepalacabangState extends State<PageOneKepalacabang>
    with AutomaticKeepAliveClientMixin<PageOneKepalacabang> {
